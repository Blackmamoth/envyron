		...
		<Card className="bg-[var(--envyron-navy)]/80 border-[var(--envyron-teal)]/30 backdrop-blur-sm hover:border-[var(--envyron-light-teal)]/50 transition-all duration-500">
			<div className="p-6">
				<div className="flex items-center justify-between mb-4">
					...
					<span className="text-[var(--envyron-light-teal)] text-sm font-mono">{currentSnippet.title}</span>
				</div>
				...
				<div className="relative min-h-[300px]">
					...
					>
						<code className="whitespace-pre-wrap break-words">{currentSnippet.code}</code>
					</pre>
