...
const features = [
  {
    ...
    description:
      "Define environment variables quickly with our intuitive interface and smart templates.",
  },
  {
    icon: FileText,
    title: "Build Templates",
    description:
      "Reuse configurations across projects with shareable, version-controlled templates.",
  },
  {
    icon: Code,
    title: "Generate Snippets",
    description:
      "Instantly export .env files, TypeScript configs, and Zod validation schemas.",
  },
];
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[var(--envyron-light-teal)] text-pretty max-w-2xl mx-auto">
            Streamline your development workflow with powerful tools for
          ...
          {features.map((feature) => (
            ...
            >
              <div className="p-8 text-center">
                ...
                <p className="text-[var(--envyron-light-teal)]/80 leading-relaxed">
                  {feature.description}
                </p>
              </div>
            </Card>
