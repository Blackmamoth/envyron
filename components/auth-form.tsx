			...
			<div className="p-8">
				...
				<form onSubmit={handleSubmit} className="space-y-4">
					<div className="space-y-2">
						<Label htmlFor="email" className="text-[var(--envyron-light-teal)]">
							Email
						</Label>
						<Input
							id="email"
					...
					<div className="space-y-2">
						<Label htmlFor="password" className="text-[var(--envyron-light-teal)]">
							Password
						</Label>
						<Input
							id="password"
				...
				{!isSignUp && (
					<div className="text-center mt-4">
						<button className="text-[var(--envyron-light-teal)]/80 hover:text-[var(--envyron-light-teal)] text-sm transition-colors duration-300 hover:underline">
							Forgot password?
						</button>
					</div>
				)}
