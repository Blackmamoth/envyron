...
export function AuthForm() {
	...
	const handleSignUpSubmit = async ({ name, email, password }: SignUpSchema) => {
			...
			<div className="p-8">
				...
				{!isSignUp && (
					<form onSubmit={signInForm.handleSubmit(handleSignInSubmit)} className="space-y-4">
						<div className="space-y-2">
							<Label htmlFor="signin-email" className="text-[var(--envyron-light-teal)]">
								Email
							</Label>
							<Input
								disabled={loading}
						...
						<div className="space-y-2">
							<Label htmlFor="signin-password" className="text-[var(--envyron-light-teal)]">
								Password
							</Label>
							<Input
								disabled={loading}
				...
				{isSignUp && (
					<form onSubmit={signUpForm.handleSubmit(handleSignUpSubmit)} className="space-y-4">
						<div className="space-y-2">
							<Label htmlFor="signup-name" className="text-[var(--envyron-light-teal)]">
								Full Name
							</Label>
							<Input
								disabled={loading}
						...
						<div className="space-y-2">
							<Label htmlFor="signup-email" className="text-[var(--envyron-light-teal)]">
								Email
							</Label>
							<Input
								disabled={loading}
						...
						<div className="space-y-2">
							<Label htmlFor="signup-password" className="text-[var(--envyron-light-teal)]">
								Password
							</Label>
							<Input
								disabled={loading}
