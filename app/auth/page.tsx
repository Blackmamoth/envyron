		...
		<main className="min-h-screen flex items-center justify-center p-6 relative">
			...
			<div className="relative z-10 w-full max-w-md">
				<div className="text-center mb-8">
					<h1 className="text-3xl font-bold text-white mb-2">Welcome to Envyron</h1>
					<p className="text-[var(--envyron-light-teal)]/80">Sign in to start managing your configurations</p>
				</div>
